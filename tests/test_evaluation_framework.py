...
def mock_jsonl_file():
    ...
    trades = [
        {"symbol": "BTC", "side": "LONG", "net_pnl": 100.0, "closed_at": "2023-01-01T10:30:00"},
        {"symbol": "ETH", "side": "SHORT", "net_pnl": -50.0, "closed_at": "2023-01-01T11:45:00"},
        {"symbol": "BTC", "side": "LONG", "net_pnl": 200.0, "closed_at": "2023-01-01T13:10:00"}
    ]
...
def test_load_trades_and_evaluate(mock_jsonl_file):
    ...
    # Generate Reports
    md = StrategyEvaluator.generate_markdown_report(tearsheet, strategy_name="Test Strategy", filepath="test_report.md")
