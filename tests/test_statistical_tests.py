...
def test_generate_block_bootstrap():
    ...
    bootstrapped = StatisticalOverfittingTests.generate_block_bootstrap(returns, block_size=3, n_bootstraps=2)
...
def test_deflated_sharpe_ratio_edge():
    ...
    dsr = StatisticalOverfittingTests.calculate_deflated_sharpe_ratio(returns, n_trials=10, var_trials=0.1)
...
def test_handsens_spa_and_wrc():
    ...
    spa = StatisticalOverfittingTests.hansens_spa(strategy, benchmark, n_bootstraps=500, block_size=2)
...
def test_p_value_bootstrap():
    ...
    p_val = StatisticalOverfittingTests.calculate_p_value_bootstrap(strategy, n_bootstraps=500, block_size=2)
