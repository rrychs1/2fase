...
def test_monte_carlo_winning_strategy():
    ...
    stats = RiskMetrics.calculate_monte_carlo_statistics(curves, 1000.0, ruin_threshold_pct=0.5)
...
def test_monte_carlo_statistical_accuracy():
    ...
    assert stats['mc_95_percentile_drawdown_pct'] < stats['mc_expected_max_drawdown_pct']
