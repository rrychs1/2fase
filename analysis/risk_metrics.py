...
class RiskMetrics:
    ...
    @staticmethod
    def calculate_volatility(returns: pd.Series, annualization_factor: int = 365) -> float:
    ...
    def run_monte_carlo_simulation(
        ...
        random_indices = np.random.randint(0, len(returns_array), size=(num_simulations, sequence_length))
    ...
    def calculate_monte_carlo_statistics(
        ...
        expected_95_drawdown = float(np.percentile(max_drawdowns, 5)) # 5th percentile is the 95% Confidence worse-case
