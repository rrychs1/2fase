...
def main():
    ...
    parser.add_argument(
        "--end", default="2026-02-01", help="End date YYYY-MM-DD (default: 2026-02-01)"
    )
    ...
    parser.add_argument(
        ...
        type=float,
        default=0.0004,
        help="Maker fee rate (default: 0.04%%)",
    )
    parser.add_argument(
        "--taker-fee",
        type=float,
        default=0.0006,
        help="Taker fee rate (default: 0.06%%)",
    )
    parser.add_argument(
        "--lookback",
        type=int,
        default=250,
        help="Lookback candles for indicators (default: 250)",
    )
    parser.add_argument(
    ...
    print(
        f"  Fees:      {args.maker_fee * 100:.2f}% maker / {args.taker_fee * 100:.2f}% taker"
    )
