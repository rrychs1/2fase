...
class VolatilityRegimeDetector:
    ...
    """
    def __init__(self, atr_period: int = 14, low_threshold: float = 1.5, high_threshold: float = 3.5):
        """
    ...
    def detect_regime(self, df: pd.DataFrame) -> str:
        ...
        if len(df) < self.atr_period + 1:
            logger.warning("Not enough data to determine volatility regime. Defaulting to MEDIUM.")
            return "MEDIUM"
