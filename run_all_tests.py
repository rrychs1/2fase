...
def main():
    ...
    tests = [
        ...
        (
            ...
            f'"{sys.executable}" -m pytest tests/test_indicators.py',
        ),
        (
            "Synthetic Indicators",
            f'"{sys.executable}" -m pytest tests/test_indicators_synthetic.py',
        ),
        (
            "Regime Transitions",
            f'"{sys.executable}" -m pytest tests/test_regime_transition.py',
        ),
